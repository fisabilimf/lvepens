...
@section('content')
    ...
    <div class="jumbotron jumbotron-fluid ">
        <div class="container1">
            <div class="rounded bg-transparent">
                <h1 class="">Cari Kegiatan Yang Cocok!</h1>
            </div>
            <form action="{{route('allexhibitions')}}" method="GET" class="search-form">
                <div class="row">
                    <div class="col-4"></div>
                    <div class="col">
                        <div class="form-group has-feedback">
                            <label for="search" class="sr-only">Search</label>
                            <input type="text" class="text-center form-control" name="name" id="" placeholder="Kata Kunci Kegiatan">
                ...
                <div class="row">
                    <div class="col"></div>
                    <button class="btn btn-link text-center text-light btn-outline-light">Cari Semua Kegiatan</button>
                    <div class="col"></div>
                </div>
            </form>
            <div class="py-1"></div>
    ...
    <div class="container">
        <div class="py-5"></div>
        <h3 class="display-4 fontrek">Rekomendasi Organisasi</h3>
        <p class="lead fontmini">Rekomendasi organisasi yang mungkin cocok</p>
        <div class="row">
        @foreach ($exhibitors as $exhibitor)
            <div class="col-md-3 rounded">
                <div class="card" style="width: 10rem;">
                    <a href="{{route('exhibitor.index', [$exhibitor->id, $exhibitor->slug])}}"><img class="card-img-top" src="{{asset('avatar')}}/{{$exhibitor->logo}}" alt="{{$exhibitor->ename}}"></a>
                    <div class="card-body">
                        <a href="{{route('exhibitor.index', [$exhibitor->id, $exhibitor->slug])}}"><h5 class="card-title text-truncate">{{$exhibitor->ename}}</h5></a>
                    </div>
                </div>
                <div class="py-2"></div>
            </div>
    ...
    <div class="container">
        <div class="row py-1">
            <div class="col">
                <div class="py-2"></div>
                <h3 class="display-4 fontrek">Rekomendasi Kegiatan</h3>
                <p class="lead fontmini">Rekomendasi kegiatan yang mungkin cocok</p>
                <div class="py-2"></div>
